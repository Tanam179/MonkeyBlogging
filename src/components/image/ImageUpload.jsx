...
const ImageUpload = (props) => {
    ...
    return (
        <label
            className={`cursor-pointer flex items-center justify-center border-2 border-dashed border-blue-300 w-full min-h-[200px] h-full rounded-lg ${className} relative overflow-hidden group`}
        >
            ...
            {!image && progress === 0 && (
                <div className="flex flex-col items-center text-center pointer-events-none">
                    <img src="/360_F_428368831_UVan10UgxCCnYgJgFMNoV2xGy7pO8utS.jpg" alt="upload-img" className="max-w-[80px] mb-5" />
